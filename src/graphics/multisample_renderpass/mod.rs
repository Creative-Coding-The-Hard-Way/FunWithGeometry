...
impl MultisampleRenderpass {
    ...
    /// # Safety
    ///
    /// Unsafe because the application must ensure that all renderpass-specific
    /// commands are added to the command buffer after this method is called.
    ...
    /// # Safety
    ///
    /// Unsafe because the application must ensure no renderpass-specific
    /// commands are added to the command buffer after calling this method.
