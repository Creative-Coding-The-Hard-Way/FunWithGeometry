...
impl CommandPool {
    ...
    /// # Safety
    ///
    /// Unsafe because the caller is responsible for freeing the buffer when
    ...
    /// # Safety
    ///
    /// Unsafe because the caller must ensure that the provided buffer was
    /// actually allocated from this pool. Additionally, there is no internal
